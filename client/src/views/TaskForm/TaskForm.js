...
class TaskForms extends Component {
  ...
  handleInputChange = e => {
    const task = this.taskName.value;
    const comment = this.taskComment.value;
    const created_date = this.taskCreateDate.value;
    const submission_date = this.taskSubmissionDate.value;
    const hourly_rate = this.taskHourlyRate.value;
    const task_status = this.state.task_status;
    const currency = this.taskCurrency.value;
    ...
    return (
      ...
      <Row>
        ...
        {this.state.form_submitted && <Alert color="primary">
            ...
            <Card>
                            <CardHeader>
                    <strong>Submit Task Detail</strong>
                    <small> Form</small>
                ...
                <CardBody>
                    ...
                    <FormGroup row>
                        <Col md="3">
                            ...
                            <Col xs="12" md="9">
                            <Input type="text"  id="task-name"  innerRef={(input)=>this.taskName = input} onChange={ this.handleInputChange } name="task-name" placeholder="Enter task name..."  required />
                    ...
                    <FormGroup row>
                        <Col md="3"> 
                            ...
                            <Col xs="12" md="9">
                            <Input type="textarea" innerRef={(input)=>this.taskComment = input} onChange={ this.handleInputChange } name="task-comment"  id="task-comment" rows="5"
                             />
                    ...
                    <FormGroup row>
                        <Col md="3"> 
                            ...
                            <Col xs="12" md="9">
                             <Input type="date" id="task-cdat" innerRef={(input)=>this.taskCreateDate = input} onChange={ this.handleInputChange } name="task-cdat"placeholder="Created Date"  required />
                    ...
                    <FormGroup row>
                        <Col md="3"> 
                            ...
                            <Col xs="12" md="9">
                             <Input type="date" id="task-sdat" innerRef={(input)=>this.taskSubmissionDate = input} onChange={ this.handleInputChange } name="task-sdat" placeholder="Target Date" />
                    ...
                    <FormGroup row>
                        <Col md="3">
                            ...
                            <Col xs="12" md="9">
                            <Input type="number"  id="task-hrate"  innerRef={(input)=>this.taskHourlyRate = input} onChange={ this.handleInputChange } name="task-name"  placeholder="Enter Hourly rate..."  required />
                    ...
                    <FormGroup row>
                        <Col md="3">
                            ...
                            <Col xs="12" md="9">
                            <Input type="text"  id="task-currency"  innerRef={(input)=>this.taskCurrency = input} onChange={ this.handleInputChange } name="task-currency"  placeholder="Enter currency symbol..."  required />
        ...
        onChangeComplete={ this.handleChangeComplete } onChange={ this.handleInputChange }/>
                                                   </Col>
                    </FormGroup>
                    <CardFooter>
                        <Button type="submit" size="sm" color="primary"><i className="fa fa-dot-circle-o"></i> Submit</Button>
                        <Button type="reset" size="sm" color="danger"><i className="fa fa-ban right"></i> Reset</Button>
                    </CardFooter>
                    </Form>
                </CardBody>
